...
import CLI from "./socialcli"
import Dashboard from "./socialdashboard"
...
The following are the social providers that LoginRadius supports.

| <!-- -->      | <!-- -->      | <!-- -->      |
| :------------ | :------------ | :------------ | 
| Facebook      | Twitter       | Google        | 
| LinkedIn      | Github        | Yahoo         | 
| Amazon        | Disqus        | Foursquare    |
| Live          | Line          | Odnoklassniki | 
| Paypal        | Pinterest     | QQ            | 
| Salesforce    | Sina Weibo    | Vkontakte     | 
| WordPress     | Mail.Ru       | Apple         |  
