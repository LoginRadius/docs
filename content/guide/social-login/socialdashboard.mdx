...
3. Upon completing the selected Social ID Provider’s configuration steps, you will get the credentials. Save these credentials and then click the **Take Me To Setup** from the guide’s right corner.
