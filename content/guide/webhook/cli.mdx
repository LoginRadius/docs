...
> Currently, Webhook configuration via CLI is only available for Developer Plans. If you wish to configure webhooks for your apps with Developer Pro Plan, kindly use dashboard instead.   
