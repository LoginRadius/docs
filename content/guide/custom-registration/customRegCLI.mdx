...
With [Loginradius CLI](https://github.com/LoginRadius/lr-cli/), You can manage your registration form fields and custom fields using the below commands:
...
The Auth Page(IDX) will display the enabled or added fields in the Register tab. For example, the following displays the added **First Name** field. You can go to your auth page using the below command.
