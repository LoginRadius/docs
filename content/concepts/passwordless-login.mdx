...
Note: In the case of Passwordless Login, the customer needs to register by providing a password. Later, the customer can log in using the password or OTP or link.
...
The following screen displays the passwordless login buttons (with OTP and with Email Link):
