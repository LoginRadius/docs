...
With [LoginRadius CLI](https://github.com/LoginRadius/lr-cli/) you can directly these simple commands from your terminal to set or get the themes.
...
<img src={require("../assets/blog-common/theme-customization.png")} alt_text={"Theme Customization"} />
