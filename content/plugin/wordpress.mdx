...
> **Disclaimer** <br/>
> LoginRadius Customer Identity and Access Management Plugin simplifies and secures your customer registration process, increases customer conversion with Social Login, and offers a full solution with Traditional customer Registration.
...
To enable authentication settings navigate to Wordpress **Admin Panel->CIAM->Authentication**, Here you will find 4 admin settings as shown in the image :
