...
> - The **return_url** is where the users will be redirected to after an action is performed successfully. It has a default value of `window.location.origin` and can be modified by passing a string as a parameter to the respective method as shown above.
...
<a href="https://github.com/LoginRadius/loginradius-react" target="_blank">
  React SDK
</a>
