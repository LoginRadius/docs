...
The tutorial helps you implement user registration, login, profile, and log out with LoginRadius in your Android mobile application.
...
> The Registration and Login functions return an `access token`.
Once the authentication is done, you can use the `access token` to retrieve profile data and handle other user functionalities. Add the following code to get the user profile:
...
Check out our Android demo to know how you can implement various LoginRadius features using the SDK and its functions.
