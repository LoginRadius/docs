...
description: "A guide to impliment LoginRadius SDK in a React Native application."
...
2. Generate your SOTT: You will need to pass a SOTT value at the time of registration. You can generate this in the [Configuration](https://dashboard.loginradius.com/configuration) section of your Dashboard. 

In your Dashboard from the left navigation bar, click the **Configuration** section then navigate to the **API Credentials** section. Open the **Secure Mobile OTP Token** subsection, configure your token information and generate your SOTT.
...
<div style="text-align:center">
  <img src="../assets/mobile-sdk/facebook-native-android.png" alt="React-Native-sott" />
</div>
...
<div style="text-align:center">
  <img src="../assets/mobile-sdk/facebook-native-ios.png" alt="React-Native-sott" />
</div>
...
<div style="text-align:center">
  <img src="../assets/mobile-sdk/google-native-android.png" alt="React-Native-sott" />
</div>
