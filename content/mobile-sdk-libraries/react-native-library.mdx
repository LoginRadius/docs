...
Before you can implement native login, you should have a look at the necessary instructions. This [link](https://developers.facebook.com/react-native/getting-started) will help you regarding the same.
