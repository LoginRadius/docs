...
- java installed on your system ([click here](https://www.java.com/en/download/help/download_options.html) to install Java as per your OS)
...
<div style="text-align:center">
  <img src="../assets/JavaIDx.png" alt="Java-app" />
</div>
