...
- Latest Node.js version installed on your system ([click here](https://nodejs.org/en/) to install latest version)
...
4. Running application.
  ...
  Open the terminal in the root folder of the application, and use the below commands to Run your application:
  ...
  And once all the dependencies have been installed run the application in your local system.
