---
title: iOS
description: "A Quick Start Guide on how to implement the user authentication in a ios application."
...
You will need to pass a SOTT value at the time of registration. You can generate this in the [Configuration](https://dashboard.loginradius.com/configuration) section of your Dashboard.
...
<div style="text-align:center">
  ...
  <img src="../assets/quick-start-guides/iOS.png" alt="Java-app" />
</div>
