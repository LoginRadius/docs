---
title: Golang
description: "A Quick Start Guide on how to implement the user authentication in a Go application."
...
<div style="text-align:center">
  <img src="../assets/quick-start-guides/golang-idx.png" alt="Go Idx" />
</div>
