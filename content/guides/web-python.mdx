...
```
cd python-idx-demo/Demo
pip install -r requirements.txt
```

This command will change the directory to Demo folder from where your application will be served and install all the required dependencies to run the python demo.
