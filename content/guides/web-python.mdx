...
This command will change the directory to Demo folder from where your application will be served and install all the required dependency to run the python demo.
