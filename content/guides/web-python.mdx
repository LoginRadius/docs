...
- python 2.7 and up ([click here](https://www.python.org/downloads/) to install python as per your OS)
- pip ([click here](https://pip.pypa.io/en/stable/installing/) to install pip)
