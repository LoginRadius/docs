---
title: Android
description: "A Quick Start Guide on how to implement the user authentication in a android application."
...
Using Android SDK V2, you will need to pass a SOTT value at the time of registration. You can generate this in the [Configuration](https://dashboard.loginradius.com/configuration) section of your Dashboard.
...
<div style="text-align:center">
  <img src="../assets/quick-start-guides/sott.png" alt="Android-sott" />
</div>
<br></br>
...
<div style="text-align:center">
  <img src="../assets/quick-start-guides/android.png" alt="Java-app" />
</div>
