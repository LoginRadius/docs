...
This guide will show you how to implement the user authentication in an android application. For this tutorial, we will use the Android demo from GitHub and show you step by step how to run it.
...
Open the dashboard, click on "Configure Your Application" and open *Mobile SOTT* . now set the time according to the requirement and generate SOTT.
