...
description: "LoginRadius provides you with the ability to control and manage your user's login session via features token lifetime, force logout, and remember me."
...
To access **Session Management** options, login to your [LoginRadius Dashboard](https://dashboard.loginradius.com/dashboard) account, from the left navigation panel, click **Security** and then navigate to the **Session Management** section.
