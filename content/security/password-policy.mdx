...
To set a Password Policy, login to your [LoginRadius Dashboard](https://dashboard.loginradius.com/dashboard) account, from the left navigation panel, click **Security** and then navigate to the **Password Policy** section. 
...
- **Common Password Protection**: Common Password Protection enables you to prevent customers from using common passwords. The list of [common passwords](/general/common-passwords/) is maintained by LoginRadius and gets updated regularly.
