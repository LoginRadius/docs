...
description: "An overview about Two Factor Authentication."
summary: "An overview about Two Factor Authentication"
---
...
> Note: When both [Passwordless Login](/howto/manage-passwordless-login/) and Two Factor Authentication (2FA) are implemented for your application, the customer will not be prompted for 2FA, if they choose to authenticate with Passwordless Login method. 
...
<div style="text-align:center">
  <img src="../assets/security/two-factor-authentication/2fa.png" alt="login_methods" />
</div>
<br/>
...
<div style="text-align:center">
  <img src="../assets/security/two-factor-authentication/main.png" alt="login_methods" />
</div>
<br/>
...
<div style="text-align:center">
  <img src="../assets/security/two-factor-authentication/onetimepasscode.png" alt="login_methods" />
</div>
<br/>
...
- Click the edit button available next to the Google Authenticator option.The following section will appear on the screen:
    ...
    <div style="text-align:center">
        <img src="../assets/security/two-factor-authentication/googleauth.png" alt="login_methods" />
    </div>
    <br/>
...
<div style="text-align:center">
  <img src="../assets/security/two-factor-authentication/google-auth-page.png" alt="login_methods" />
</div>
<br/>