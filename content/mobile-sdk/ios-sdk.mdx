...
|---|----|----|
|SOTT|Secure One-time Token which you can check information about sott [here](https://dashboard.loginradius.com/dashboard)|Yes for Registration.  You can generate a long term SOTT token from the Dadhboard
...
1. Web Social Login: This is done using `SFSafariViewController` or `UIWebView`.
  ...
  > Note: Facebbok and Google no longer allow OAuth requests in embedded browsers on iOS.
