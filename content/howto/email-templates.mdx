...
Login to your <a href="https://dashboard.loginradius.com/dashboard" target="_blank">LoginRadius Dashboard</a>  account, navigate to **Configuration** and click the **Login Methods** section to expand and click the **Edit** icon given next to the Email/Password provider, as highlighted in the screen below.:

<div style="text-align:center">
  <img src="../assets/email_template_1.png" alt="email_template_form" />
</div>
<br/>

The following are the default email templates provided by **LoginRadius Login Methods**:
...
<div style="text-align:center">
  <img src="../assets/email_template_2.jpg" alt="email_template_form" />
</div>
