...
The User Management section contains all the registered customers on your application. This feature also allows you to manage your customers without needing to create your management tool. You can perform actions like - add, search, send a reset password link, and block or delete customers.

To access the User Management section, login to your [LoginRadius Dashboard](https://dashboard.loginradius.com/dashboard) account, from the left navigation panel, click the **User Management** and then navigate to the **Manage User** section. The below screen will appear:
...
- Customer Profile: Contains Name, UID, Email, etc.
...
To add a new customer, click the **ADD USER** button available on the bottom right of the page. From the appeared list, click the **Create User** and the Create User pop-up will appear:
