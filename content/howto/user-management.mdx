...
To access the User Management section, login to your [LoginRadius Dashboard](https://dashboard.loginradius.com/dashboard) account, from the left navigation panel, click **User Management** and then navigate to the **Manage User** section. The below screen will appear:
