...
description: "A Details overview Overview about Team Management."
...
To access Team Management, login to your [LoginRadius Dashboard](https://dashboard.loginradius.com/dashboard) account, from the left navigation panel, click **Teams**. The **Team Management** screen will appear:
