...
<div style="text-align:center">
  <img src="../assets/auth_0.png" alt="auth_0" />
</div>
<br/>
...
<div style="text-align:center">
  <img src="../assets/auth_1.png" alt="auth_1" /> 
</div>
<br/>
...
<div style="text-align:center">
  <img src="../assets/auth_2.png" alt="auth_2" />
</div>
<br/>

**General Configuration**: You can manage the **Favicon** and **Logo** for your authentication pages as explained below: 
 - **Favicon**: Enter the URL for your favicon resource, or upload one of your own.
 - **Logo**: Enter the URL for your logo resource, or upload one of your own.
...
<div style="text-align:center">
  <img src="../assets/auth_3.png" alt="auth_3" />
</div>
<br/>
...
<div style="text-align:center">
  <img src="../assets/auth_4.png" alt="auth_4" />
</div>
<br/>
...
**Note:**
**Try It Out button** will navigate you to your Auth Page (IDX) where you can see all the changes. The URL of the Auth Page (IDX) is unique for your app. Your customers will be registering and logging on this page.