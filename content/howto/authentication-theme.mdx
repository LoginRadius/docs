...
<iframe width="480" height="250" src="https://www.youtube.com/embed/0AO9xR18wxs" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>

<hr/>

You can choose a theme from the available option and then customize it using the editor.
...
To access **Auth Page (IDX)** customization, login to your [LoginRadius Dashboard](https://dashboard.loginradius.com/dashboard) account, from the left navigation panel, click **Auth Page (IDX)** and the following screen will appear:
