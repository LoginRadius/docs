...
**To change form settings**: 
 - Find functions `showLogin, showRegister, showForgotPassword` in **default-auth-before-script.js** and customize it for your requirements just below the default code.
- Find functions `LoginRadiusRaaS.\$hooks.setRenderProfileEditor` in **default-profile-before-script.js** and customize it for your requirements just below the default code.
