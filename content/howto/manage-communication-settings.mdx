...
1. Login to your [LoginRadius Dashboard](https://dashboard.loginradius.com/dashboard) account, from the left navigation panel, click the **Configuration** and then navigate to the **Email/SMS Provider Settings** section.  Click the down arrow or anywhere within the section. The **SMTP Provider Settings** screen will appear:
...
1. Login to your [LoginRadius Dashboard](https://dashboard.loginradius.com/dashboard) account, from the left navigation panel, select the **Configuration** and then navigate to the **Email/SMS Provider Settings** sections.Click the down arrow or anywhere within this section and then select the **SMS Settings** option as highlighted in the below screenL 
