---
title: Manage Email/SMS Provider Settings
description: "An Overview about Manage Email/SMS Provider Settings for email and sms providers."
summary: "An Overview about Manage Email/SMS Provider Settings for email and sms providers"
---
...
LoginRadius Identity Platform allows you to configure your SMTP provider settings and generic email settings in the Email/SMS Provider Settings section.
...
1. Login to your [LoginRadius Dashboard](https://dashboard.loginradius.com/dashboard) account, from the left navigation panel, click **Configuration** and then navigate to the **Email/SMS Provider Settings** section.  Click the down arrow or anywhere within the section. The **SMTP Provider Settings** screen will appear:
...
The LoginRadius Identity Platform allows you to configure your SMS provider settings and generic SMS settings in the **Email/SMS Provider Settings** section.
...
1. Login to your [LoginRadius Dashboard](https://dashboard.loginradius.com/dashboard) account, from the left navigation panel, select **Configuration** and then navigate to the **Email/SMS Provider Settings** section. Click the down arrow or anywhere within this section and then select the **SMS Settings** option as highlighted in the below screen: 
