...
You can manage the [Email](/howto/manage-communication-settings#email-configuration) and [SMS](/howto/manage-communication-settings#sms-configuration) providers and settings for your LoginRadius App.

## Email Configuration

LoginRadius Identity Platform allows you to configure your [SMTP provider settings](/howto/manage-communication-settings#smtp-provider-settings) and generic [email settings](/howto/manage-communication-settings#email-settings) in the Communication Setting section.
...
1. Login to your [LoginRadius Dashboard](https://dashboard.loginradius.com/dashboard) account, rom the left navigation panel, click the **Configuration** and then navigate to the **Communication Settings** section.  Click the down arrow or anywhere within the section. The **SMTP Provider Settings** screen will appear:
